...
import RestrictedMusicCard from '../components/MusicLibraryComponent/RestrictedMusicCard';
...
const LibraryPage = () => {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-b from-slate-900 via-purple-900 to-slate-900 overflow-auto">
      <motion.main 
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
