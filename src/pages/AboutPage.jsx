...
const footerNavigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/profile.php?id=61559963660373',
      icon: (props) => (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/karaorchee/',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
...
export default function AboutPage() {
  ...
  useEffect(() => {
    ...
    return () => {
      if (phoneRef.current) {
        phoneRef.current.removeEventListener('mouseenter', () => {});
        phoneRef.current.removeEventListener('mouseleave', () => {});
      }
    };
  }, []);
        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            ...
            >
              ...
              <img className="h-16 w-auto" src="pic/Final-08.png" alt="" />
            </a>
          </div>
        ...
        <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              ...
              >
                <span className="sr-only">Your Company</span>
                <img className="h-8 w-auto" src="pic/Final-08.png" alt="" />
              </a>
              <button
                type="button"
          ...
          <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Conduct Your Orchestra, Anywhere, Anytime
                Perform with a customized AI-driven Orchestra that follows your instructions.
                KaraOrchee invites musicians into a global community to connect, collaborate, and create, anytime and anywhere.
              </p>
              <p className="mt-6 text-lg leading-8 text-gray-600">
            ...
            <div className="mt-16 sm:mt-24 lg:mt-0 lg:flex-shrink-0 lg:flex-grow">
              <div 
                ref={phoneRef}
                className="mx-auto w-[22.875rem] max-w-full transition-all duration-300"
                style={{
                  filter: 'drop-shadow(0 15px 15px rgba(0,0,0,0.1))',
                  cursor: 'pointer'
                }}
      ...
      <footer className="mt-32 bg-gray-900 sm:mt-56" aria-labelledby="footer-heading">
        ...
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <img className="h-14" src="pic/Final-08.png" alt="Company name" />
          ...
          <div className="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
              &copy; 2024 Karaorchee Company, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
